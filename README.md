# KREA GTM Leader Search

Confidential GTM leader shortlist for KREA

**Live URL**: `https://ade-B10.github.io/krea-gtm-search/`
...
2. Enter the team password (saved in 1Password under "KREA GTM Leader Search")
...
```bash
cd /Users/ade/Desktop/Urizen/krea-gtm-search-deploy

# 1. Drop the updated unencrypted HTML into source/
cp /Users/ade/Desktop/Urizen/KREA_GTM_Leader_Shortlist.html source/
...
# 3. Commit and push
git add index.html
git commit -m "Refresh KREA GTM Leader Search ($(date +%Y-%m-%d))"
git push
```
