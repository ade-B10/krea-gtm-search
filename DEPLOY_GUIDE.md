...
You're deploying to: `https://ade-B10.github.io/krea-gtm-search/`
Password (save in 1Password under "KREA GTM Leader Search"): `Krea-GTM-B10-2026`
...
2. Repository name: `krea-gtm-search`
...
2. In Finder, open `/Users/ade/Desktop/Urizen/krea-gtm-search-deploy/`
...
`https://github.com/ade-B10/krea-gtm-search/settings/pages`
...
1. Under "Build and deployment":
   ...
   - **Branch**: `main` / `/ (root)`
2. Click **Save**
3. Wait ~30 seconds. The page will show: "Your site is live at `https://ade-B10.github.io/krea-gtm-search/`"

## Done.

Open the URL. You'll see a password prompt. Enter `Krea-GTM-B10-2026`. The page loads.
...
- Ask in Claude to "update KREA GTM Leader Search with [the new info]"
- Claude will edit `source/KREA_GTM_Leader_Shortlist.html`, run `./update.sh`, and tell you the exact commit message
- You just commit + push (or paste the new `index.html` into GitHub web UI)

**DIY path:**
1. Update `source/KREA_GTM_Leader_Shortlist.html` directly (or have Claude do it)
2. In Terminal: `cd ~/Desktop/Urizen/krea-gtm-search-deploy && ./update.sh`
...
- **"Wrong password"** — Confirm exact case + special characters. Password is: `Krea-GTM-B10-2026`
